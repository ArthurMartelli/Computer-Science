...
```mermaid
graph LR
    S1[Determinar la naturaleza\ny nivel de necesidad de\ninformación]
    S2[Acceder a la información\nde manera eficaz\ny eficiente]
    S3[Evaluar críticamente la\n información obtenida\ny sus fuentes]
    S4[Comunicar la información]
    S4[Usar información\nética, legal y \nrespetuosamente]
...
digraph ORG {
  ...
  Capitulo1     [ label = "Capítulo 1"   ]
  Capitulo2     [ label = "Capítulo 2"   ]
  Capitulo3     [ label = "Capítulo n"   ]
  Epigrafe1     [ label = "Epígrafe 1"   ]
  Epigrafe2     [ label = "Epígrafe 2"   ]
  Epigrafe3     [ label = "Epígrafe n"   ]
  Hoja1         [ label = "Hoja 1"       ]
  Hoja2         [ label = "Hoja 2"       ]
  Hoja3         [ label = "Hoja 3"       ]
  Texto         [ label = "Texto"        ]
  ...
  Presentacion -> Capitulo1 -> Epigrafe1;
